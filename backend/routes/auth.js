...
router.get(
  ...
  passport.authenticate('github', {
    failureRedirect: 'https://chanet-974929463300.asia-south2.run.app/auth/github/callback', // Redirect here if authentication fails
    successRedirect: 'https://chanet-974929463300.asia-south2.run.app/auth/github/callback',      // Redirect here if authentication succeeds
  })
);
